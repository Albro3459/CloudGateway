...
public final class CloudGatewayTunnelPendingStartBarrier: @unchecked Sendable {
    ...
    public func prepareJoinedStop(
        completion: @escaping @Sendable () -> Void
    ) -> CloudGatewayTunnelStartStopJoin {
        let join = CloudGatewayTunnelStartStopJoin(completion: completion)
