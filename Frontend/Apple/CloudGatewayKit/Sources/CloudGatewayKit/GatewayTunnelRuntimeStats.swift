...
public struct GatewayTunnelRuntimeStats: Equatable, Sendable {
    ...
    public static func parse(_ uapiConfiguration: String) -> GatewayTunnelRuntimeStats? {
        var sawPeer = false
        ...
        return GatewayTunnelRuntimeStats(
