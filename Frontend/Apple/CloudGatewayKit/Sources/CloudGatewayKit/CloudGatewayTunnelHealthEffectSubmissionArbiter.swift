...
protocol CloudGatewayTunnelHealthEffectSubmissionExecuting: Sendable {
...
private final class CloudGatewayTunnelHealthSerialSubmissionExecutor:
...
final class CloudGatewayTunnelHealthEffectSubmissionTicket: @unchecked Sendable {
    let generation: UInt64
    let sequence: UInt64
    private weak var arbiter: CloudGatewayTunnelHealthEffectSubmissionArbiter?

    fileprivate init(
        generation: UInt64,
        sequence: UInt64,
        arbiter: CloudGatewayTunnelHealthEffectSubmissionArbiter
    ) {
...
final class CloudGatewayTunnelHealthEffectSubmissionArbiter: @unchecked Sendable {
    ...
    private let executor: any CloudGatewayTunnelHealthEffectSubmissionExecuting
    ...
    init(
        executor: any CloudGatewayTunnelHealthEffectSubmissionExecuting =
            CloudGatewayTunnelHealthSerialSubmissionExecutor(),
    ...
    func submit(
        ...
        _ submission: @escaping @Sendable (
            CloudGatewayTunnelHealthEffectSubmissionTicket
        ) -> Void
    ) -> Bool {
        lock.lock()
        ...
        let ticket = CloudGatewayTunnelHealthEffectSubmissionTicket(
    ...
    private func start(
        _ ticket: CloudGatewayTunnelHealthEffectSubmissionTicket,
